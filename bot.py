...
developers = ['831161538']


addusr = ""
tk = os.getenv("5187544759:AAEV4LFQVwBP8XuMMMC0o_47LyKBeLMODoQ")
mode = os.getenv("MODE")
...
@run_async
def start(update):
	update.message.reply_text("This CC Scraper has been started successfully | Developed by X_PIRATE")
